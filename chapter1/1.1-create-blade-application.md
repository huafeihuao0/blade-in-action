...
然后加入 `blade-mvc` 的依赖，具体版本可以在 [github](https://github.com/biezhi/blade) 查看或者在 [maven](http://search.maven.org/#search%7Cga%7C1%7Cblade-mvc) 仓库搜索，尽量使用较新版本，我当前使用的版本是 `2.0.0`
